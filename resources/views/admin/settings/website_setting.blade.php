              ...
              <form role="form" action="{{route('website.setting.update',$setting->id)}}" method="Post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <img src="{{ asset($setting->logo? "/public/uploads/files/setting/".$setting->logo :'') }}" alt="logo" class="img-rounded img-fluid">
                    <input type="file" class="form-control" name="logo" >
                    <input type="hidden" name="old_logo" value="{{$setting->logo}}">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Favicon</label>
                    <img src="{{ asset($setting->logo? "/public/uploads/files/setting/".$setting->favicon :'') }}" alt="logo" class="img-rounded img-fluid">
